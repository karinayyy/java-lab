...
//    }
    ...
    static MetroStream createSubwayStation() {
        MetroStream station = new MetroStream("new Itäkeskus", 1983);
        Hour[] hours = new Hour[]{
                new Hour(1267, "test com to new Itäkeskus"),
                new Hour(123, "not many people new Itäkeskus"),
                new Hour(10, "midnight new Itäkeskus"),
                new Hour(1500, "short new Itäkeskus"),
                new Hour(1000, "some comment new Itäkeskus")
        };
...
//        System.out.printf("The shortest period ==> %d %s", this.getShortestPeriod().getDays(), "days");
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        stat.test();
        MetroStream metroStream = new MetroStream("Kholodnogirska", 2022);
        Hour[] hours = new Hour[]{
